  ...
  <div>
    <div class="wrapper">
      ...
      <div class="search">
        ...
        <span class="search__text">山姆会员</span>
      </div>
      <div class="banner">
        <img 
        class="banner__img" 
        ...
        <div class="nearby__item">
          ...
          <div class="nearby__content">
            ...
            <div class="nearby__content__tags">
              <span class="nearby__content__tag">月售一万+</span>
              <span class="nearby__content__tag">月售一万+</span>
              <span class="nearby__content__tag">月售一万+</span>
            </div>
            <p class="nearby__content__highlight">VIP尊享满89元减4元</p>
          </div>
        </div>
        <div class="nearby__item">
          <img 
    ...
    <div class="docker">
      <section class="docker__item docker__item--active">
        <div class="iconfont">&#xe6f9;</div>
        <div class="docker__title">首页</div>
      </section>
      <section class="docker__item">
        <div class="iconfont">&#xe6bc;</div>
